...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Audit>(entity =>
            {
                ...
                entity.Property(e => e.DbOjbectName).HasMaxLength(100);

                entity.Property(e => e.OperationTypeId).HasColumnName("OperationTypeID");

                entity.Property(e => e.ReocordId).HasColumnName("ReocordID");
            ...
            {
                entity.ToTable("OrgPosition", "look");
            ...
            modelBuilder.Entity<OrgUnitType>(entity =>
            {
                ...
                entity.Property(e => e.IsHead).HasDefaultValueSql("false");
            ...
            modelBuilder.Entity<Position>(entity =>
            {
                ...
                entity.Property(e => e.Reference).HasMaxLength(14);
                ...
                entity.Property(e => e.WorkingAreaId).HasColumnName("WorkingAreaID");
            ...
            {
                entity.ToTable("ProcessConnection", "look");
            ...
            modelBuilder.HasSequence<int>("OperationType_ID_seq");

            modelBuilder.HasSequence("documents_id_seq");

            modelBuilder.HasSequence<int>("Organization_ID_seq");

            modelBuilder.HasSequence<int>("ProcessTracking_ID_seq");
            ...
            modelBuilder.HasSequence<short>("OrgUnitType_ID_seq");
            ...
            modelBuilder.HasSequence<int>("Screens_ID_seq");
