...
namespace NHCM.Persistence.NewModels
{
    public partial class HCMContext : DbContext
    {
        ...
        public virtual DbSet<JudgesPromotion> JudgesPromotion { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.ToTable("Attendance", "rec");

                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .HasColumnType("numeric")
                    .HasDefaultValueSql("nextval('rec.attendance_id_seq'::regclass)");
                ...
                entity.Property(e => e.Workinghours).HasColumnType("numeric");

                entity.HasOne(d => d.IdNavigation)
                    .WithOne(p => p.InverseIdNavigation)
                    .HasForeignKey<Attendance>(d => d.Id)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_attendance_attendance");
            ...
            modelBuilder.Entity<District>(entity =>
            {
                ...
                entity.Property(e => e.Sorter).HasMaxLength(200);
            });
            ...
            modelBuilder.Entity<Education>(entity =>
            {
                ...
                entity.Property(e => e.ModidfiedBy)
                    .IsRequired()
                    .HasMaxLength(200);
            ...
            {
                entity.ToTable("EmployeePromotion", "rec");

                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .HasColumnType("numeric")
                    .HasDefaultValueSql("nextval('rec.employeepormotion_id_seq'::regclass)");

                entity.Property(e => e.AuthorizeDate).HasColumnType("date");

                entity.Property(e => e.AuthorizeNumber).HasMaxLength(50);
                ...
                entity.HasOne(d => d.Person)
                    .WithMany(p => p.EmployeePromotion)
                    .HasForeignKey(d => d.PersonId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_employeepormotion_person");
            });
            ...
            modelBuilder.Entity<FeedbackChoice>(entity =>
            {
                entity.ToTable("FeedbackChoice", "look");

                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .HasDefaultValueSql("nextval('look.feedbackchoice_id_seq'::regclass)");
            ...
            modelBuilder.Entity<FeedbackOption>(entity =>
            {
                entity.ToTable("FeedbackOption", "look");
            ...
            modelBuilder.Entity<JudgesPromotion>(entity =>
            {
                entity.ToTable("JudgesPromotion", "rec");

                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .HasColumnType("numeric")
                    .HasDefaultValueSql("nextval('rec.judgespromotion_id_seq'::regclass)");

                entity.Property(e => e.AuthorizeDate).HasColumnType("timestamp with time zone");

                entity.Property(e => e.AuthorizeNo).HasMaxLength(50);

                entity.Property(e => e.CreatedOn)
                    .HasColumnType("timestamp with time zone")
                    .HasDefaultValueSql("now()");

                entity.Property(e => e.EnteryDate).HasColumnType("timestamp with time zone");

                entity.Property(e => e.EnteryNumber).HasMaxLength(50);

                entity.Property(e => e.ImplementionDate).HasColumnType("timestamp with time zone");

                entity.Property(e => e.ImplementionNo).HasMaxLength(50);

                entity.Property(e => e.MaktobDate).HasColumnType("date");

                entity.Property(e => e.MaktobNumber).HasMaxLength(50);
                ...
                entity.HasOne(d => d.IdNavigation)
                    .WithOne(p => p.InverseIdNavigation)
                    .HasForeignKey<JudgesPromotion>(d => d.Id)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_judgespromotion_judgespromotion");

                entity.HasOne(d => d.Person)
                    .WithMany(p => p.JudgesPromotion)
                    .HasForeignKey(d => d.PersonId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_judgespromotion_person");
            });
            ...
            modelBuilder.Entity<Organization>(entity =>
            {
                ...
                entity.Property(e => e.KeyOutComeDari).HasColumnName("KeyOutCome_Dari");
                ...
                entity.Property(e => e.StrategicObject).HasMaxLength(2000);
            });
            ...
            modelBuilder.HasSequence("translog_id_seq");
