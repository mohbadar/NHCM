    ...
    require(
        ...
        function (ec, limitless) {
            ...
            basic_pie_options = {
                ...
                // Add title
                title: {
                    text: 'به اساس درجه تحصیل',
                    subtext: 'احصائیه کارمندان به اساس درجه تحصیل',
                    x: 'center'
                },
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left', 
                    data: ['بکلوریا', 'لیسانس', 'ماستر', 'دوکتورا', 'بی سواد']
                },
                ...
                series: [{
                    ...
                    center: ['50%', '57.5%'],
                    data: [
                        { value: 1548, name: 'بکلوریا'},
                        { value: 310, name: 'لیسانس'},
                        { value: 234, name: 'ماستر'},
                        { value: 135, name: 'دوکتورا'},
                        { value: 335, name: 'بی سواد'}
                    ]
                }]
            };
            ...
            basic_donut_options = {
                ...
                // Add title
                title: {
                    text: 'به اساس رتبه / بست',
                    subtext: 'احصائیه کارمندان به اساس رتبه / بست',
                    x: 'center'
                },
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['مجموعه', 'بست دوم','بست سوم','بست جهارم','بست پنجم','درجه ۲']
                },
                ...
                series: [{
                    ...
                    center: ['50%', '57.5%'],
                    data: [
                        { value: 2500, name: 'مجموعه' },
                        { value: 500, name: 'بست دوم' },
                        { value: 500, name: 'بست سوم' },
                        { value: 500, name: 'بست جهارم' },
                        { value: 500, name: 'بست پنجم' },
                        { value: 500, name: 'درجه ۲' },
                    ]
                }]
            };
            ...
            nested_pie_options = {
                ...
                title: {
                    text: 'به اساس جنسیت',
                    subtext: 'احصایه کارمندان به اساس جنسیت',
                    x: 'center'
                },
                // Add tooltip
                tooltip: {
